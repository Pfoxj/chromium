# TrashOS Code of Conduct

Pfoxj and the TrashOS Team are committed to preserving and fostering a
 ...
 * respectful and kind;
 * about TrashOS Or Anything That Comes With It;
...
discrimination, or condescension, whether blatant or subtle. Remember that TrashOS will
be geographically distributed and that you may not be
...
discretion of the TrashOS Team:

 * a private or public warning or reprimand;
 * a temporary ban from TrashOS services, this repository, or if a really bad voilation, ALL of TrashOS;
 * a permanent ban from any of the above.
